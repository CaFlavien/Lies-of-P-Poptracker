...
LOCATION_MAPPING = {
    ...
    -- =========================================================
    -- Barren Swamp (IDs 424-494, 499-505, 743, 1104)
    -- =========================================================
    ...
    [743] = { "@Barren Swamp - Locations/next to minecart shortcut" },
    ...
    -- =========================================================
    -- Krat Central Station Return (IDs 506-547, 744-745)
    -- =========================================================
    ...
    [744] = { "@Krat Central Station Return - Locations/behind wall when revisiting start" },
    [745] = { "@Krat Central Station Return - Locations/safe behind wall at train revisit" },


    -- =========================================================
    -- Collapsing Krat (IDs 548-577, 705-706)
    -- =========================================================
    ...
    [705] = { "@Collapsing Krat - Locations/Red Fox's Hunting Apparel" },
    [706] = { "@Collapsing Krat - Locations/Vessel Quartz" },
    ...
    -- =========================================================
    -- Arche Abbey Entrance (IDs 641-647)
    -- =========================================================

    [641] = { "@Arche Abbey Entrance - Locations/corpse on ledge" },
    [642] = { "@Arche Abbey Entrance - Locations/ledge next to ladder" },
    [643] = { "@Arche Abbey Entrance - Locations/wood beam" },
    [644] = { "@Arche Abbey Entrance - Locations/corner near cannon" },
    [645] = { "@Arche Abbey Entrance - Locations/next to cannon" },
    [646] = { "@Arche Abbey Entrance - Locations/near barricade" },
    [647] = { "@Arche Abbey Entrance - Locations/chest on bridge" },

    -- =========================================================
    -- Arche Abbey Lower Outer Wall (IDs 648-677)
    -- =========================================================

    [648] = { "@Arche Abbey Lower Outer Wall - Locations/before drop down" },
    [649] = { "@Arche Abbey Lower Outer Wall - Locations/ledge" },
    [650] = { "@Arche Abbey Lower Outer Wall - Locations/next to ladder" },
    [651] = { "@Arche Abbey Lower Outer Wall - Locations/on stack of books" },
    [652] = { "@Arche Abbey Lower Outer Wall - Locations/in front of cauldron" },
    [653] = { "@Arche Abbey Lower Outer Wall - Locations/Red Butterfly drop" },
    [654] = { "@Arche Abbey Lower Outer Wall - Locations/next to altar" },
    [655] = { "@Arche Abbey Lower Outer Wall - Locations/next to bench" },
    [656] = { "@Arche Abbey Lower Outer Wall - Locations/drop down" },
    [657] = { "@Arche Abbey Lower Outer Wall - Locations/corpse in small room" },
    [658] = { "@Arche Abbey Lower Outer Wall - Locations/next to bookcase" },
    [659] = { "@Arche Abbey Lower Outer Wall - Locations/chest in small room" },
    [660] = { "@Arche Abbey Lower Outer Wall - Locations/drop down in trap tower" },
    [661] = { "@Arche Abbey Lower Outer Wall - Locations/on roof(1)" },
    [662] = { "@Arche Abbey Lower Outer Wall - Locations/on roof(2)" },
    [663] = { "@Arche Abbey Lower Outer Wall - Locations/chest next to altar" },
    [664] = { "@Arche Abbey Lower Outer Wall - Locations/ledge across small wooden beam" },
    [665] = { "@Arche Abbey Lower Outer Wall - Locations/small wood beam after jump" },
    [666] = { "@Arche Abbey Lower Outer Wall - Locations/ledge after ladder" },
    [667] = { "@Arche Abbey Lower Outer Wall - Locations/ledge above wooden platform" },
    [668] = { "@Arche Abbey Lower Outer Wall - Locations/small room with trap" },
    [669] = { "@Arche Abbey Lower Outer Wall - Locations/on ledge" },
    [670] = { "@Arche Abbey Lower Outer Wall - Locations/Alchemist's Cape" },
    [671] = { "@Arche Abbey Lower Outer Wall - Locations/Quartz" },
    [672] = { "@Arche Abbey Lower Outer Wall - Locations/center of room" },
    [673] = { "@Arche Abbey Lower Outer Wall - Locations/ledge after elevator drop" },
    [674] = { "@Arche Abbey Lower Outer Wall - Locations/chest after elevator drop" },
    [675] = { "@Arche Abbey Lower Outer Wall - Locations/Orange Butterfly drop" },
    [676] = { "@Arche Abbey Lower Outer Wall - Locations/small statues" },
    [677] = { "@Arche Abbey Lower Outer Wall - Locations/below elevator" },

    -- =========================================================
    -- Arche Abbey Upper Outer Wall (IDs 678-704, 707)
    -- =========================================================

    [678] = { "@Arche Abbey Upper Outer Wall - Locations/small room to left of first big room" },
    [679] = { "@Arche Abbey Upper Outer Wall - Locations/under archway straight from first big room" },
    [680] = { "@Arche Abbey Upper Outer Wall - Locations/small room to left of second big room" },
    [681] = { "@Arche Abbey Upper Outer Wall - Locations/under archway right from second big room" },
    [682] = { "@Arche Abbey Upper Outer Wall - Locations/in front of gate in third big room" },
    [683] = { "@Arche Abbey Upper Outer Wall - Locations/small room to left of third big room" },
    [684] = { "@Arche Abbey Upper Outer Wall - Locations/next to gate that opens in final room" },
    [685] = { "@Arche Abbey Upper Outer Wall - Locations/next to ladder to second level" },
    [686] = { "@Arche Abbey Upper Outer Wall - Locations/after lever to open gate" },
    [687] = { "@Arche Abbey Upper Outer Wall - Locations/chest in dead-end on second level" },
    [688] = { "@Arche Abbey Upper Outer Wall - Locations/after gate" },
    [689] = { "@Arche Abbey Upper Outer Wall - Locations/Puppet Elite drop" },
    [690] = { "@Arche Abbey Upper Outer Wall - Locations/Red Butterfly drop (1)" },
    [691] = { "@Arche Abbey Upper Outer Wall - Locations/behind boxes next to ladder" },
    [692] = { "@Arche Abbey Upper Outer Wall - Locations/platform on second level" },
    [693] = { "@Arche Abbey Upper Outer Wall - Locations/dead-end off to the side" },
    [694] = { "@Arche Abbey Upper Outer Wall - Locations/wood beam near shortcut ladder" },
    [695] = { "@Arche Abbey Upper Outer Wall - Locations/Red Butterfly drop (2)" },
    [696] = { "@Arche Abbey Upper Outer Wall - Locations/corner of section of small wood beams" },
    [697] = { "@Arche Abbey Upper Outer Wall - Locations/dead-end behind wall" },
    [698] = { "@Arche Abbey Upper Outer Wall - Locations/chest in lower section" },
    [699] = { "@Arche Abbey Upper Outer Wall - Locations/drop down from upper section" },
    [700] = { "@Arche Abbey Upper Outer Wall - Locations/chest in trap room" },
    [701] = { "@Arche Abbey Upper Outer Wall - Locations/ledge by trap room" },
    [702] = { "@Arche Abbey Upper Outer Wall - Locations/Carcass Elite drop" },
    [703] = { "@Arche Abbey Upper Outer Wall - Locations/before wall the Carcass Elite breaks" },
    [704] = { "@Arche Abbey Upper Outer Wall - Locations/corpse in small room" },
    [707] = { "@Arche Abbey Upper Outer Wall - Locations/Laxasia drop" },

    -- =========================================================
    -- Arche Abbey Inside (IDs 708-725)
    -- =========================================================

    [708] = { "@Arche Abbey Inside - Locations/in room near Sophia's actual body" },
    [709] = { "@Arche Abbey Inside - Locations/on unused elevator" },
    [710] = { "@Arche Abbey Inside - Locations/dead-end upstairs" },
    [711] = { "@Arche Abbey Inside - Locations/balcony upstairs" },
    [712] = { "@Arche Abbey Inside - Locations/under archway" },
    [713] = { "@Arche Abbey Inside - Locations/next to bookcase" },
    [714] = { "@Arche Abbey Inside - Locations/drop down by stairs" },
    [715] = { "@Arche Abbey Inside - Locations/chest in room down stairs" },
    [716] = { "@Arche Abbey Inside - Locations/next to cauldron" },
    [717] = { "@Arche Abbey Inside - Locations/dead-end behind stairs" },
    [718] = { "@Arche Abbey Inside - Locations/before wood beam" },
    [719] = { "@Arche Abbey Inside - Locations/on ledge" },
    [720] = { "@Arche Abbey Inside - Locations/dead-end across first wood beam" },
    [721] = { "@Arche Abbey Inside - Locations/dead-end before second wood beam" },
    [722] = { "@Arche Abbey Inside - Locations/dead-end across second wood beam" },
    [723] = { "@Arche Abbey Inside - Locations/next to elevator" },
    [724] = { "@Arche Abbey Inside - Locations/before Geppetto" },
    [725] = { "@Arche Abbey Inside - Locations/given from Geppetto" },

    -- =========================================================
    -- Arche Abbey Passageway (IDs 726-742)
    -- =========================================================

    [726] = { "@Arche Abbey Passageway - Locations/beneath shortcut ladder" },
    [727] = { "@Arche Abbey Passageway - Locations/chest after jump" },
    [728] = { "@Arche Abbey Passageway - Locations/chest around a ledge" },
    [729] = { "@Arche Abbey Passageway - Locations/on ledge (1)" },
    [730] = { "@Arche Abbey Passageway - Locations/above stargazer" },
    [731] = { "@Arche Abbey Passageway - Locations/on metal ledge" },
    [732] = { "@Arche Abbey Passageway - Locations/Disruption Mini Victor Elite drop" },
    [733] = { "@Arche Abbey Passageway - Locations/chest at dead-end" },
    [734] = { "@Arche Abbey Passageway - Locations/ledge before small bridge" },
    [735] = { "@Arche Abbey Passageway - Locations/next to metal wall" },
    [736] = { "@Arche Abbey Passageway - Locations/on ledge (2)" },
    [737] = { "@Arche Abbey Passageway - Locations/on ledge (3)" },
    [738] = { "@Arche Abbey Passageway - Locations/on altar" },
    [739] = { "@Arche Abbey Passageway - Locations/on table before Simon Manus boss" },
    [740] = { "@Arche Abbey Passageway - Locations/Fallen One's Ergo" },
    [741] = { "@Arche Abbey Passageway - Locations/Arm of God" },
    [742] = { "@Arche Abbey Passageway - Locations/Nameless Puppet drop" }
}