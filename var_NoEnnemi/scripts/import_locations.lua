...
-- Ch11 - Arche Abbey Entrance
Tracker:AddLocations("locations/ch11_arche_abbey_entrance.json")
Tracker:AddLocations("locations/logics/ch11_arche_abbey_entrance.json")

-- Ch11 - Arche Abbey Lower Outer Wall
Tracker:AddLocations("locations/ch11_arche_abbey_lower_outer_wall.json")
Tracker:AddLocations("locations/logics/ch11_arche_abbey_lower_outer_wall.json")

-- Ch11 - Arche Abbey Upper Outer Wall
Tracker:AddLocations("locations/ch11_arche_abbey_upper_outer_wall.json")
Tracker:AddLocations("locations/logics/ch11_arche_abbey_upper_outer_wall.json")

-- Ch11 - Arche Abbey Inside
Tracker:AddLocations("locations/ch11_arche_abbey_inside.json")
Tracker:AddLocations("locations/logics/ch11_arche_abbey_inside.json")

-- Ch11 - Arche Abbey Passageway
Tracker:AddLocations("locations/ch11_arche_abbey_passageway.json")
Tracker:AddLocations("locations/logics/ch11_arche_abbey_passageway.json")
