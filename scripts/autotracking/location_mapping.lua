...
LOCATION_MAPPING = {
    ...
    -- =========================================================
    -- Collapsing Krat (IDs 506-547)
    -- =========================================================

    [548] = { "@Collapsing Krat - Locations/dead-end near disruption crystal" },
    [548] = { "@Collapsing Krat - Locations/next to disruption crystal across sign" },
    [548] = { "@Collapsing Krat - Locations/dead-end" },
    [548] = { "@Collapsing Krat - Locations/Purple Butterfly drop" },
    [548] = { "@Collapsing Krat - Locations/corpse next to disruption crystal" },
    [548] = { "@Collapsing Krat - Locations/ledge next to disruption crystals" },
    [548] = { "@Collapsing Krat - Locations/dead end next to disruption crystals" },
    [548] = { "@Collapsing Krat - Locations/ledge" },
    [548] = { "@Collapsing Krat - Locations/on painting" },
    [548] = { "@Collapsing Krat - Locations/small dead-end near disruption crystal" },
    [548] = { "@Collapsing Krat - Locations/Carcass Elite drop" },
    [548] = { "@Collapsing Krat - Locations/near Carcass Elite" },
    [548] = { "@Collapsing Krat - Locations/next to trash can" },
    [548] = { "@Collapsing Krat - Locations/under workshop table" },
    [548] = { "@Collapsing Krat - Locations/on a workshop table" },
    [548] = { "@Collapsing Krat - Locations/lower ledge with fire enemy" },
    [548] = { "@Collapsing Krat - Locations/chest above area with crystals" },
    [548] = { "@Collapsing Krat - Locations/ladder to top of workshop" },
    [548] = { "@Collapsing Krat - Locations/Legion Caliber" },
    [548] = { "@Collapsing Krat - Locations/Dark Moon Moonstone of the Covenant" },
    [548] = { "@Collapsing Krat - Locations/next to some boxes" },
    [548] = { "@Collapsing Krat - Locations/under a archway" },
    [548] = { "@Collapsing Krat - Locations/Red Butterfly drop" },
    [548] = { "@Collapsing Krat - Locations/dead-end by cliffs" },
    [548] = { "@Collapsing Krat - Locations/next to wagon" },
    [548] = { "@Collapsing Krat - Locations/before drop down" },
    [548] = { "@Collapsing Krat - Locations/infront of a bush" },
    [548] = { "@Collapsing Krat - Locations/Full Moonstone" },
    [548] = { "@Collapsing Krat - Locations/Quartz" },
